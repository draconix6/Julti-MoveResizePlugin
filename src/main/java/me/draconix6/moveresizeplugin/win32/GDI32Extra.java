...
//    int StretchDIBits(HDC hdcDest, int xDest, int yDest, int wDest, int hDest, int xSrc, int ySrc, int wSrc, int hSrc, byte[] lpBits, );
    ...
    class BITMAPINFOHEADER extends Structure {
        public WinDef.DWORD biSize;
        public WinDef.LONG  biWidth;
        public WinDef.LONG  biHeight;
        public WinDef.WORD  biPlanes;
        public WinDef.WORD  biBitCount;
        public WinDef.DWORD biCompression;
        public WinDef.DWORD biSizeImage;
        public WinDef.LONG  biXPelsPerMeter;
        public WinDef.LONG  biYPelsPerMeter;
        public WinDef.DWORD biClrUsed;
        public WinDef.DWORD biClrImportant;
    }
}